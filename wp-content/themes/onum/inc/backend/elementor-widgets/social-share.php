 ...
 */
class Onum_SocialShare extends Widget_Base{
	...
	public function get_title() {
		return __( 'Onum Social Share', 'onum' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'social_share',
			[
				'label' => __( 'Social Share Buttons', 'onum' ),
				'type' => Controls_Manager::SELECT2,
				'multiple' => true,
				'options' => [
					'facebook' 		=> __( 'Facebook', 'onum' ),					
					'twitter' 		=> __( 'Twitter', 'onum' ),
					'google'  		=> __( 'Google Plus', 'onum' ),					
					'pinterest' 	=> __( 'Pinterest', 'onum' ),
					'linkedin'  	=> __( 'Linkedin', 'onum' ),					
					'buffer' 		=> __( 'Buffer', 'onum' ),
					'digg'  		=> __( 'Digg', 'onum' ),					
					'reddit' 		=> __( 'Reddit', 'onum' ),
					'tumbleupon'  	=> __( 'Tumbleupon', 'onum' ),					
					'tumblr' 		=> __( 'Tumblr', 'onum' ),
					'vk' 			=> __( 'Vk', 'onum' ),
					'email' 		=> __( 'Email', 'onum' ),
					'print' 		=> __( 'Print', 'onum' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => 'solid',
				'options' => [
					'rounded'  => __( 'Rounded', 'onum' ),
					'square' => __( 'Square', 'onum' ),
					'circle' => __( 'Circle', 'onum' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'default_color'  => __( 'Official Color', 'onum' ),
					'custom_color' => __( 'Custom', 'onum' ),
				],
			]
		);
		$this->add_control(
...
Plugin::instance()->widgets_manager->register( new Onum_SocialShare() );