<?php 
class Onum_Author_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            ...
            'OT Author', // Name
            array( 'description' => esc_html__( 'A Author Widget', 'onum' ), 'classname' => 'onum_author-widget' ) // Args
        );
    }
 	...
 	public function author_scripts() {
	   ...
	   wp_enqueue_media();
	   wp_enqueue_script('onum_upload_media_admin', get_template_directory_uri() . '/inc/backend/js/upload_media_widget.js', array('jquery'));
	}
    ...
    public function widget( $args, $instance ) {
        ...
        <div class="author-widget_wrapper text-center">
            <div class="author-widget_image-wrapper">
                <img class="author-widget_image img-circle" width="150" height="150" src="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr($title); ?>">
            </div>
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php echo esc_html__( 'Name:', 'onum' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php echo esc_html__( 'Description:', 'onum' ); ?></label>
...
add_action( 'widgets_init', 'onum_author_register_widgets' );
function onum_author_register_widgets() {
    register_widget( 'Onum_Author_Widget' );
}