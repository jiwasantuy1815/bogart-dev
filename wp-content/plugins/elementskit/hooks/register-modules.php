	...
	public function get_list($list) {
		...
		return array_merge($list, [
			...
			'glass-morphism' => [
				...
				'base_class_name'   => '\ElementsKit\Modules\Glass_Morphism\Init',
			],
			'mouse-cursor' => [
				'slug'              => 'mouse-cursor',
				'package'           => 'pro',
				'title'             => 'Mouse Cursor',
				'base_class_name'   => '\ElementsKit\Modules\Mouse_Cursor\Init',
			],
			'liquid-glass' => [
				'slug'              => 'liquid-glass',
				'package'           => 'pro',
				'title'             => 'Liquid Glass',
				'base_class_name'   => '\ElementsKit\Modules\Liquid_Glass\Init',
			],
		]);
	}
}