...
class ElementsKit_Widget_table extends Widget_Base {
    ...
    protected function register_controls() {
		...
		$this->add_control(
			'ekit_table_search_icon',
			[
				'label' => esc_html__( 'Search Icon', 'elementskit' ),
				'type' => Controls_Manager::ICONS,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-container' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-wid-con .ekit_table  button.dt-button' => 'border-style: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .ekit-wid-con .ekit_table  button.dt-button' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition'  => [
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .ekit-wid-con .ekit_table button.dt-button, {{WRAPPER}} .ekit-wid-con .ekit_table button.dt-button:active' => 'border-color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#cacaca',
                'selectors' => [
                    '{{WRAPPER}} .ekit-table-search-label :is(svg, i)' => 'color: {{VALUE}}; fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors'  => array(
                    '{{WRAPPER}} .ekit-table-search-label :is(svg, i)' => 'font-size: {{SIZE}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dt-search input' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-search input' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
			...
			[
				...
				'label'       => esc_html__( 'Border', 'elementskit' ),
				'selector'    => '{{WRAPPER}} .dt-search input',
			]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dt-search input' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;',
				],
			]
        );
        ...
        $this->start_controls_tabs(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .dt-search input' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .dt-search input' => 'background-color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .dt-search input:hover' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .dt-search input:hover' => 'background-color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .dt-search input:focus' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .dt-search input:focus' => 'background-color: {{VALUE}};',
                    ],
                ]
            );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' =>esc_html__( 'Typography', 'elementskit' ),
                'selector' => '{{WRAPPER}} .ekit_table .dt-container .dt-search input::placeholder',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ekit_table .dt-container .dt-search input::placeholder' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->start_controls_tabs(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .dt-info:hover' => 'color: {{VALUE}};',
                    ],
                ]
            );
        ...
        $this->add_group_control(
            ...
            array(
				...
				'default' => '#6E5BDE',
				'selector' => '{{WRAPPER}} .dt-length label, {{WRAPPER}} .dt-length select',
            )
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .dt-length select' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .dt-length' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
			...
			[
				...
				'label'       => esc_html__( 'Border', 'elementskit' ),
				'selector'    => '{{WRAPPER}} .dt-length label',
			]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .dt-length label' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' =>esc_html__( 'Typography', 'elementskit' ),
                'selector' => '{{WRAPPER}} .dt-length select',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .dt-length select' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-paging' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-paging' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dt-paging' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;',
				],
			]
		);
        ...
        $this->add_group_control(
            ...
            array(
				...
				'selector' => '{{WRAPPER}} .dt-paging button',
            )
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:is(.previous)' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:is(.next)' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:is(.previous, .next)' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:is(.previous, .next)' => 'border-style: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:is(.previous, .next)' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .dt-paging button:is(.previous)'  => 'border-left: none !important; border-top: none !important; border-bottom: none;',
                    '{{WRAPPER}} .dt-paging button:is(.next)'  => 'border-right: none !important; border-top: none !important; border-bottom: none;'
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:is(.previous, .next)' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
                    'ekit_tbl_nav_btn_border_type!' =>  'none',
                ]
        ...
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dt-paging button:is(.previous, .next)' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; overflow: hidden;',
				],
			]
        );
        ...
        $this->add_group_control(
			...
			[
              ...
              'selector' => '{{WRAPPER}} .dt-paging button:is(.previous, .next)',
              'separator' => 'after',
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:is(.previous, .next)' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:not(.first, .previous, .next, .last)' => 'width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:not(.first, .previous, .next, .last)' => 'height: {{SIZE}}{{UNIT}};line-height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_tbl_nav_number_use_width_height'  => 'yes'
                ] 
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                ...
                'selector'	 => '{{WRAPPER}} .dt-paging button:not(.first, .previous, .next, .last), {{WRAPPER}}  .dt-paging .ellipsis',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:not(.first, .previous, .next, .last)' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:not(.first, .previous, .next, .last)' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:not(.first, .previous, .next, .last)' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .dt-paging button:not(.first, .previous, .next, .last)',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:not(.first, .previous, .next, .last), {{WRAPPER}} .dt-paging .ellipsis' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            array(
				...
				'selector' => '{{WRAPPER}} .dt-paging button:not(.first, .previous, .next, .last):hover',
            )
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button:not(.first, .previous, .next, .last):hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            array(
				...
				'selector' => '{{WRAPPER}} .dt-paging button.current',
            )
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .dt-paging button.current' => 'color: {{VALUE}};',
                ],
            ]
        );
	...
	protected function ekit_parse_csv_to_table($filename, $header = true) {
		...
		$response = wp_safe_remote_get($filename);
...
<table class="display" style="width:100%">
	<thead>
		<tr>
			<?php foreach(str_getcsv($data[0]) as $th): ?>
	...
	<tbody>
		...
		<tr>
			...
			<td data-order="<?php echo esc_attr($td); ?>">
				<div class="ekit_table_body_container"><?php echo esc_html($td); ?></div>
			</td>
			<?php endforeach; ?>
		</tr>
		<?php endforeach; ?>
...
<?php
    ...
    protected function render_csv_data($url){
        ...
        ob_start();
        if($url_ext === 'csv'){
            echo \ElementsKit_Lite\Utils::render($this->ekit_parse_csv_to_table($url, true)); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
        } else {
            echo '<p class="ekit-no-csv-file-found">'. esc_html__('Please provide an csv file', 'elementskit') .'</p>';
        }
        return \ob_get_clean();
    ...
    protected function render_raw( ) {
        ...
        $table_settings = [
            ...
            'info_text'         => !empty($settings['info_text']) ? $settings['info_text'] : '',
            'entries_text'      => !empty($settings['entries_text']) ? $settings['entries_text'] : '',
            'ordering'          => $settings['show_ordering'] == 'yes' ? true : false,
			'searchIcon'        => $settings['ekit_table_search_icon'] ?  Icons_Manager::try_get_icon_html( $settings['ekit_table_search_icon'], [ 'aria-hidden' => 'true' ] ): '',
...
<div class="ekit_table display  ekit_table_data_type-<?php echo esc_attr( $ekit_table_data_type ); ?>"
	<?php $this->print_render_attribute_string('table'); ?>>
	<?php
                
                if($ekit_table_data_type == 'custom'){

                    echo '<table id="ekit-table-container-'.esc_attr($this->get_id()).'" class="display dataTable" style="width:100%"><thead><tr>';
                    echo \ElementsKit_Lite\Utils::render($settings['show_serial'] === 'yes' ? "<th>". esc_html( $settings['show_serial_header_text'] ) ."</th>" : ''); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                   foreach((array)$ekit_table_build_header as $head){
                       $id =  $head['_id'];
                       if ( $head['cell_icon_type'] != 'none' ) {
                           $this->add_render_attribute( 'headicon-' . esc_attr($id), 'class', 'ekit-table-icon' );
                           $this->add_render_attribute( 'headicon-' . esc_attr($id), 'class', 'ekit-table-icon-' . esc_attr($head['cell_icon_position']) );
                       }

                       ?>
	<th class="elementor-repeater-item-<?php echo esc_attr($head['_id']); ?>">
		<div
			class="ekit_table_item_container  ekit-table-container-<?php echo esc_attr($head['cell_icon_position']); ?> ">
			<?php 
                                    echo esc_html( $head['table_header_content'] ); 

                                    if ( $head['cell_icon_type'] != 'none') { ?>
			<span <?php echo $this->get_render_attribute_string( 'headicon-' . esc_attr($id) ); ?>> <?php
				...
				<?php
                                                ...
                                                echo \Elementskit_Lite\Utils::get_attachment_image_html($head, 'cell_icon_image', 'full' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                            }
                                        ?></span><?php
                                    }
                                ?>
                   ...
                   $row_count = 1;
                    foreach((array)$table_body_content as $key => $bodycon){
                        ...
                        if($bodycon['ekit_table_row'] == 'Row') {
                            echo "<tr>";
                            echo \ElementsKit_Lite\Utils::render($settings['show_serial'] === 'yes' ? '<td class="elementor-repeater-item-'. esc_attr($bodycon['_id']) .' ekit_table_data_'. esc_attr( $bodycon['cell_icon_position'] ) .'"><div class="ekit_table_body_container ekit_table_data_'. esc_attr( $bodycon['cell_icon_position'] ) .' ekit_body_align_'. esc_attr( $settings['body_align'] ) .'">'. esc_html($row_count) .'</div></td>' : '');
                            $row_count++;
                        }
                        ...
                        // Output: table data 
                        ?>
	<td data-order="<?php echo wp_strip_all_tags( wp_kses($bodycon['cell_text'], \ElementsKit_Lite\Utils::get_kses_array())); ?>"
		class="elementor-repeater-item-<?php echo esc_attr($bodycon['_id']); ?> ekit_table_data_<?php echo esc_attr($bodycon['cell_icon_position']); ?>">
		<?php if($enabledUrl === 'yes') : ?>
		<a <?php $this->print_render_attribute_string( 'link-'. $key ); ?>>
			<?php endif; ?>

			<div
				class="ekit_table_body_container ekit_table_data_<?php echo esc_attr($bodycon['cell_icon_position']); ?> ekit_body_align_<?php echo esc_attr($settings['body_align']); ?>">
				<?php 
                                            
                                            echo wp_kses($bodycon['cell_text'], \ElementsKit_Lite\Utils::get_kses_array());

                                            if ( $bodycon['body_cell_icon_type'] != 'none') { ?>

				<span
					class="body_cell_icon body-cell-icon-position-<?php echo esc_attr( $bodycon['cell_icon_position']  ) ?>"> <?php
					...
					<?php
                                                    ...
                                                    echo \Elementskit_Lite\Utils::get_attachment_image_html($bodycon, 'body_cell_icon_image', 'full' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                                }
	...
	<?php
                    ...
                    if($ekit_table_csv_type === 'file'){
                        ...
                        if($ekit_table_upload_csv['url'] != ''){
                            echo \ElementsKit_Lite\Utils::render($this->render_csv_data($ekit_table_upload_csv['url'])); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                        }

                    } else if($ekit_table_csv_type === 'url'){
                        if($ekit_table_csv_url['url'] != ''){
                            echo \ElementsKit_Lite\Utils::render($this->render_csv_data($ekit_table_csv_url['url'])); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                        }

                    } else if($ekit_table_csv_type === 'google_sheet_viewer_url') {
                        if($ekit_table_google_sheet_viewer_url['url'] != ''){
                            echo \ElementsKit_Lite\Utils::render($this->render_google_sheet_data($ekit_table_google_sheet_viewer_url['url'])); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                        }
                    }
