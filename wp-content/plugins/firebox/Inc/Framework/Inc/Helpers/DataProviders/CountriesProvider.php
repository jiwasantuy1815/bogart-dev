...
class CountriesProvider implements GetSelectedItems, GetSearchItems
{
	/**
    ...
    {
		$countries = fpframework()->helper->countries;
		
		$parsed = [];

		foreach ($countries::getCountriesList() as $key => $value)
		{
