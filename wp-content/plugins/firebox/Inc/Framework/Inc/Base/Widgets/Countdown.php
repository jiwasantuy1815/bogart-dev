...
class Countdown extends Widget
{
	...
	protected $widget_options = [
		...
		// The digit border width
		'digit_border_width' => '',

		// The digit border style
		'digit_border_style' => '',

		// The digit border color
		'digit_border_color' => '',
	...
	private function setCSSVars()
	{
		...
		if ($this->options['theme'] !== 'custom')
		{
			...
			if (!empty($this->options['digit_border_width']) && !empty($this->options['digit_border_style']) && !empty($this->options['digit_border_color']))
			{
