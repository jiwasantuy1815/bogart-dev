...
<div class="fpf-library-footer">
    <a class="parent" href="<?php echo esc_url($this->data->get('create_new_template_link', '')); ?>">
        ...
        <?php echo esc_html(fpframework()->_('FPF_START_FROM_SCRATCH')); ?>
    </a>
    <a target="_blank" href="<?php echo esc_url(FPF_SUPPORT_URL); ?>?topic=Feature Request">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <?php echo esc_html(fpframework()->_('FPF_REQUEST_TEMPLATE')); ?>
    </a>
</div>