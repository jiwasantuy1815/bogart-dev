...
<div class="fpf-library-sidebar">
	...
	<div class="top">
		<div class="flex-container align-center align-middle">
			<div class="fpf-library-sidebar-toggle opener" title="<?php echo esc_attr(fpframework()->_('FPF_OPEN_SIDEBAR')); ?>">
			...
			<div class="on-sidebar-open flex-container align-center align-middle fpf-library-sidebar-toggle" title="<?php echo esc_attr(fpframework()->_('FPF_CLOSE_SIDEBAR')); ?>">
				...
				<span class="top-title"><?php echo esc_html(fpframework()->_('FPF_FILTERS')); ?></span>
			</div>
		</div>
	...
	<div class="fpf-library-sidebar-filters">
		<?php echo esc_html(fpframework()->_('FPF_LOADING_FILTERS')); ?>
	</div>
	<!-- /Filters -->
</div>