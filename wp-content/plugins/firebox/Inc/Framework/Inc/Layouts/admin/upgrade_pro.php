...
<div class="pro-only-body text-center">
    ...
    <p>
        <a class="fpf-button upgrade large" data-href="<?php echo esc_url(FPF_SITE_URL); ?>{{PLUGIN_SLUG}}/upgrade?utm_source=product&utm_campaign=firebox-free&utm_medium=pro-feature" href="#" target="_blank">
