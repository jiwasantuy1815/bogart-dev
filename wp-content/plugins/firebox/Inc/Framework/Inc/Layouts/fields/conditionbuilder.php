...
<div class="fpf-conditionbuilder-wrapper">
    <input type="hidden" name="<?php echo esc_attr($this->data->get('name')); ?>" value="<?php echo esc_attr($value); ?>" />
    <div class="fpf-conditionbuilder"
        data-plugin="<?php echo esc_attr($this->data->get('plugin')); ?>"
        data-exclude_rules_pro="<?php echo esc_attr($this->data->get('exclude_rules_pro')); ?>"
        data-include-rules="<?php echo esc_attr(wp_json_encode($this->data->get('include_rules'))); ?>"
        data-exclude-rules="<?php echo esc_attr(wp_json_encode($this->data->get('exclude_rules'))); ?>">
        <div class="fpf-conditionbuilder-initial-message">
            ...
            <?php echo esc_html(fpframework()->_('FPF_DISPLAY_CONDITIONS_LOADING')); ?>
        </div>
        <div class="fpf-conditionbuilder-groups"></div>
        <div class="actions">
            <a class="fpf-conditionbuilder-button fpf-cb-add-new-group" href="#" title="<?php echo esc_html(fpframework()->_('FPF_CB_NEW_CONDITION_GROUP')); ?>">
                <span class="dashicons dashicons-plus"></span>
                <span class="text"><?php echo esc_html(fpframework()->_('FPF_CB_NEW_CONDITION_GROUP')); ?></span>
