...
class ViewedAnotherBoxHelper
{
	/**
	 * Viewed Another Box Provider
	 * 
	 * @var  ViewedAnotherBoxProvider
	 */
	private $provider;
	...
	public function __construct($provider = null)
	{
		...
		if (!$provider)
		{
			$provider = new \FireBox\Core\Helpers\DataProviders\ViewedAnotherBoxProvider();
		}
	 ...
	 * @return  array
	 */
	public static function parseData($boxes)
	{
		$boxes = (array) $boxes;
