...
class EDD extends EndpointController
{
	/**
	 * Endpoint name
	 * 
    ...
    public function get_downloads_page_data($request)
    {
        ...
        $items = fpframework()->helper->edd->getItems($offset, $per_page);
    ...
    public function get_downloads_ids_data($request)
    {
        ...
        $items = fpframework()->helper->edd->getSelectedItems($ids);
    ...
    public function get_downloads_search_data($request)
    {
        ...
        $items = fpframework()->helper->edd->getSearchItems($query);
    ...
    public function get_category_page_data($request)
    {
        ...
        $items = fpframework()->helper->eddcategory->getItems($offset, $per_page);
    ...
    public function get_category_ids_data($request)
    {
        ...
        $items = fpframework()->helper->eddcategory->getSelectedItems($ids);
    ...
    public function get_category_search_data($request)
    {
        ...
        $items = fpframework()->helper->eddcategory->getSearchItems($query);
