...
use Barn2\Plugin\Document_Library_Pro\Dependencies\Barn2\Settings_API\Traits\With_Manager;
...
abstract class Field implements Field_Interface, JsonSerializable
{
     ...
     * @return void
     */
    public function __construct(string $name, string $label, string $description = '', string $tooltip = '', array $attributes = [], $default_value = null, array $conditions = [], array $effects = [])
    {
        $this->name = $name;
        $this->label = $label;
     ...
     * {@inheritDoc}
     */
    public function set_effects(array $effects) : self
    {
        $this->effects = $effects;
        return $this;
    }
    ...
    {
        return ['name' => $this->get_name(), 'label' => $this->get_label(), 'type' => $this->get_type(), 'default' => $this->get_default(), 'description' => $this->get_description(), 'attributes' => $this->get_attributes(), 'tooltip' => $this->get_tooltip(), 'conditions' => $this->get_conditions(), 'effects' => $this->get_effects()];
    }
}
