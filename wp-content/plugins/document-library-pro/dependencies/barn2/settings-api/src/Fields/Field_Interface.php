...
interface Field_Interface
{
    ...
    /**
     * Set the field's effects.
     *
     * Each field can declare an effects array,
     * these are rules that describe how this field should react when another field changes.
     *
     * $primary_color->set_effects([
     *  [
     *      'watchField' => 'template',
     *      'value'      => 'modern',
     *      'setValue'   => '#FF0000'
     ...
     * ]);
     *
     * @param array $effects The field effects.
     * @return self
     */
    public function set_effects(array $effects) : self;
    /**
     * Get the field's effects.
     *
     * @return array
     */
