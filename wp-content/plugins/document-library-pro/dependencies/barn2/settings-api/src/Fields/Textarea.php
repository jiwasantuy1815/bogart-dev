...
use Barn2\Plugin\Document_Library_Pro\Dependencies\Barn2\Settings_API\Traits\With_Size;
/**
...
class Textarea extends Field
{
     ...
     * {@inheritDoc}
     *
     * @param string $value The value of the textarea field to sanitize.
     */
    public function sanitize($value)
    {
        if (isset($this->attributes['sanitize']) && !$this->attributes['sanitize']) {
            return $value;
        }
