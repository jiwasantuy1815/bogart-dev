...
use Barn2\Plugin\Document_Library_Pro\Dependencies\Barn2\Settings_API\Fields\License;
...
class Rest_Api implements Rest_Api_Interface
{
    ...
    public function save_settings(\WP_REST_Request $request) : \WP_REST_Response
    {
        ...
        if (!\is_array($settings)) {
            return new WP_REST_Response(['message' => __('Something went wrong. Please try again.', 'document-library-pro')], 400);
        }
        ...
        if ($has_validation) {
            ...
            if (!$validated) {
                return new WP_REST_Response(['message' => __('Something went wrong during validation. Please try again.', 'document-library-pro')], 400);
            }
