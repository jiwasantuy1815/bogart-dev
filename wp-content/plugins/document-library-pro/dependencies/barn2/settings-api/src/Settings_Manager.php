 ...
 */
namespace Barn2\Plugin\Document_Library_Pro\Dependencies\Barn2\Settings_API;

use Barn2\Plugin\Document_Library_Pro\Dependencies\Lib\Plugin\Plugin;
use JsonSerializable;
use Barn2\Plugin\Document_Library_Pro\Dependencies\Barn2\Settings_API\Tabs\Tab_Interface;
/**
...
class Settings_Manager implements JsonSerializable
{
    ...
    public function register_and_enqueue_assets() : void
    {
        ...
        \wp_register_script($asset_name, $this->library_url . '/assets/js/admin/settings-panel.js', \array_merge(['wp-color-picker'], Util::get_script_dependencies($this, 'admin/settings-panel.js')['dependencies']), $this->plugin->get_version(), \true);
    ...
    {
        return ['not_found_title' => __('Page not found', 'document-library-pro'), 'not_found_text' => __('The page you are looking for does not exist.', 'document-library-pro'), 'not_found_back' => __('Go back', 'document-library-pro'), 'save_changes' => __('Save changes', 'document-library-pro'), 'settings_saved' => __('Your settings have been saved.', 'document-library-pro'), 'check' => __('Check', 'document-library-pro'), 'activate' => __('Activate', 'document-library-pro'), 'deactivate' => __('Deactivate', 'document-library-pro')];
    }
    /**
    ...
    {
        $types = ['button' => Fields\Button::class, 'checkbox' => Fields\Checkbox::class, 'checkboxes' => Fields\Checkboxes::class, 'color_size' => Fields\Color_Size::class, 'color' => Fields\Color::class, 'columns_editor' => Fields\Columns_Editor::class, 'hidden' => Fields\Hidden::class, 'license' => Fields\License::class, 'multiselect' => Fields\Multiselect::class, 'image_label' => Fields\Image_Label::class, 'number' => Fields\Number::class, 'post_select' => Fields\Post_Select::class, 'radio' => Fields\Radio::class, 'select' => Fields\Select::class, 'text' => Fields\Text::class, 'textarea' => Fields\Textarea::class, 'toggle' => Fields\Toggle::class];
        /**
    ...
    public function jsonSerialize()
    {
        ...
        return ['tabs' => $this->tabs, 'layout' => $this->layout, 'apiURL' => $this->api->get_api_namespace(), 'lang' => $this->get_lang_config(), 'options' => $this->get_all_options(), 'hasLicenseOverride' => $override === 'true' || $override === 'barn2media'];
    }
}
