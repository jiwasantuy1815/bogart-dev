 ...
 */
class Single_Content implements Registerable, Premium_Service {
	...
	public function maybe_allow_shortcodes( $excerpt ) {
		if ( is_singular( Post_Type::POST_TYPE_SLUG ) && isset( Options::get_user_shortcode_options()['shortcodes'] ) && Options::get_user_shortcode_options()['shortcodes'] ) {
			...
			<div id="dlp-document-info-list">
				...
				<?php if ( in_array( 'filename', $display_options, true ) && $document->get_file_name() ) : ?>
					<div class="dlp-document-info-filename">
						...
						<?php echo $document->get_file_name(); ?>
					</div>
				<?php endif; ?>
				...
				<?php if ( in_array( 'file_size', $display_options, true ) && $document->get_file_size() ) : ?>
					<div class="dlp-document-info-file-size">
						...
						<?php echo $document->get_file_size(); ?>
					</div>
				<?php endif; ?>
